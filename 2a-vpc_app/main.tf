module "vpc_app" {
  ...
  vpc_settings = {
    nacl_rules = {
      public = {
        ingress = {
          # SSH       = { rule_number = 100, cidr_block = "${data.aws_ssm_parameter.my_ip.value}/32", port = 22 }, # BASTION HOST
        ...
        egress = {
          ...
          # SSH       = { rule_number = 100, port = 22 }, # BASTION HOST
          #HTTP      = { rule_number = 200, cidr_block = "0.0.0.0/0", port = 80 }, # BATION HOST
          HTTP      = { rule_number = 210, port = 80 }
          #HTTPS     = { rule_number = 300, cidr_block = "0.0.0.0/0", port = 443 }, # BATION HOST
      ...
      private = {
        ingress = {
          ...
          HTTP           = { rule_number = 102, port = 80, cidr_block = "0.0.0.0/0" },                        # USER DATA
          ...
          EPHEMERAL_NAT = { rule_number = 400, cidr_block = "0.0.0.0/0", from_port = 1024, to_port = 65535 }
        },
        egress = {
