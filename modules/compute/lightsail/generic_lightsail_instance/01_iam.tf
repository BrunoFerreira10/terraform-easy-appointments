...
resource "aws_iam_policy" "read_build_on_s3" {
...
resource "aws_iam_user_policy_attachment" "lightsail_instance_attach_policyread_build_on_s3" {
  user       = aws_iam_user.lightsail_instance.name
  policy_arn = aws_iam_policy.read_build_on_s3.arn
}
