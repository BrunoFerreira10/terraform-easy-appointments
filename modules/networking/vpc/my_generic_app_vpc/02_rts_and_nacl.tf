...
locals {
  nacl_rules = {
    public = {
      ingress = {
        SSH       = { rule_number = 103, cidr = "0.0.0.0/0", port = 22 },
        HTTP      = { rule_number = 203, cidr = "0.0.0.0/0", port = 80 },
        HTTPS     = { rule_number = 303, cidr = "0.0.0.0/0", port = 443 },
        EPHEMERAL = { rule_number = 403, cidr = "0.0.0.0/0", from_port = 1024, to_port = 65535 }
      },
      egress = {
        SSH       = { rule_number = 103, cidr = "0.0.0.0/0", port = 22 },
        HTTP      = { rule_number = 203, cidr = "0.0.0.0/0", port = 80 },
        HTTPS     = { rule_number = 303, cidr = "0.0.0.0/0", port = 443 },
        MYSQL     = { rule_number = 403, cidr = "0.0.0.0/0", port = 3306 },
        EPHEMERAL = { rule_number = 503, cidr = "0.0.0.0/0", from_port = 32768, to_port = 65535 }
      }
    },
    private = {
      ingress = {
        SSH       = { rule_number = 103, cidr = aws_vpc.app.cidr_block, port = 22 },
        HTTP      = { rule_number = 203, cidr = "0.0.0.0/0", port = 80 },
        HTTPS     = { rule_number = 303, cidr = "0.0.0.0/0", port = 443 },
        MYSQL     = { rule_number = 403, cidr = "0.0.0.0/0", port = 3306 },
        EPHEMERAL = { rule_number = 503, cidr = "0.0.0.0/0", from_port = 32768, to_port = 65535 }
      ...
      egress = {
        EPHEMERAL = { rule_number = 103, cidr = "0.0.0.0/0", from_port = 1024, to_port = 65535 }
      }
    }
  }
}
